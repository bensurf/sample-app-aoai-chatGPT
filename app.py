...
async def init_openai_client():
    ...
    try:
        ...
        # Authentication
        deepseek_api_key = app_settings.azure_openai.key
        ...
        azure_deepseek_client = ChatCompletionsClient(
            endpoint='https://DeepSeek-R1-ngtya.westus.models.ai.azure.com',
            credential=AzureKeyCredential(deepseek_api_key)
)

        return azure_deepseek_client
    except Exception as e:
        logging.exception("Exception in Azure Deepseek initialization", e)
        azure_deepseek_client = None
        raise e
...
async def send_chat_request(request_body, request_headers):
    ...
    try:
        ...
        raw_response = await azure_openai_client.complete(**model_args)
